...
ten_km <- readRDS("./occupancy/model_outputs/bombus/bombus_10km_1200minpop_10minpersp_4ints_3visits_.RDS")
fifteen_km <- readRDS("./occupancy/model_outputs/bombus/bombus_15km_1000minpop_10minpersp_4ints_3visits_.RDS")
twenty_km <- readRDS("./occupancy/model_outputs/bombus/bombus_20km_800minpop_10minpersp_4ints_3visits_.RDS")
twentyfive_km <- readRDS("./occupancy/model_outputs/bombus/bombus_25km_600minpop_10minpersp_4ints_3visits_.RDS")
...
estimate <-  c(
  ...
  # param 3 (psi natural)
  fit_summary_10$summary[8,1],
  fit_summary_15$summary[8,1],
  fit_summary_20$summary[8,1],
  fit_summary_25$summary[8,1]
)
...
lower_95 <- c(
  ...
  # param 3 (psi natural)
  fit_summary_10$summary[8,4],
  fit_summary_15$summary[8,4],
  fit_summary_20$summary[8,4],
  fit_summary_25$summary[8,4]
) 
...
upper_95 <- c(
  ...
  # param 3 (psi natural)
  fit_summary_10$summary[8,8],
  fit_summary_15$summary[8,8],
  fit_summary_20$summary[8,8],
  fit_summary_25$summary[8,8]
) 
...
lower_50 <- c(
  ...
  # param 3 (psi natural)
  fit_summary_10$summary[8,5],
  fit_summary_15$summary[8,5],
  fit_summary_20$summary[8,5],
  fit_summary_25$summary[8,5]
) 
...
upper_50 <- c(
  ...
  # param 3 (psi natural)
  fit_summary_10$summary[8,7],
  fit_summary_15$summary[8,7],
  fit_summary_20$summary[8,7],
  fit_summary_25$summary[8,7]
) 
